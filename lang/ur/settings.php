...
return [
    ...
    'font_size' => 'فونٹ سائز',
    'font_size_hint' => 'اس دکان کے تمام صارفین کے لیے ایپ کے ہر حصے کا آن اسکرین ٹیکسٹ چھوٹا یا بڑا کرتا ہے۔ پرنٹ شدہ رسیدیں متاثر نہیں ہوتیں۔',
    'font_size_decrease' => 'فونٹ سائز کم کریں',
    'font_size_increase' => 'فونٹ سائز بڑھائیں',
    'font_size_preview_text' => 'یہ اس سائز میں ایپ کے ٹیکسٹ کا پیش منظر ہے۔',
