...
<html lang="en">
    <head>
        ...
        <title>Pesticides Management System</title>
    </head>
    <body style="font-family: system-ui, sans-serif; display: flex; min-height: 100vh; align-items: center; justify-content: center; margin: 0; background: #f7fafc; color: #1a202c;">
